...
public class AdminController {
    ...
    public String orderList(Model model, //
                            @RequestParam(value = "page", defaultValue = "1") String pageStr, HttpServletRequest request, Principal principal) {
        int page = 1;
        try {
        ...
        PaginationResult<OrderInfo> paginationResult //
                = orderDAO.listOrderInfo(page, MAX_RESULT, MAX_NAVIGATION_PAGE, principal.getName());
    ...
    @RequestMapping(value = "/discountMaker",method = RequestMethod.GET)
    public String foo(){
        return "discountMaker";
    }

    @RequestMapping(value = "/discountMaker",method = RequestMethod.POST)
    public String makeDiscount(HttpServletRequest request){
        discountDAO.saveDiscount(request.getParameter("code"), request.getParameter("amount"));
